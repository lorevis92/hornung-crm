export default {
  ...
  taxSettings: {
    ...
    scope: 'Ebene',
    value: 'Wert',
    valueAmount: 'Wert (CHF)',
    valuePercent: 'Wert (%)',
    valueType: 'Werttyp',
    valueType_fixed_amount: 'Fester Betrag (CHF)',
    valueType_percentage: 'Prozentsatz',
    valueType_formula: 'Formel',
    valueType_no_cap: 'Kein Höchstbetrag',
    noCap: 'Kein Höchstbetrag',
    noCapHint: 'Dieser Parameter kennt keine betragsmässige Obergrenze.',
    notes: 'Notizen',
    notesHint: 'Optional — erklären Sie die Regel in einfacher Sprache, z. B. bei einem formelbasierten Parameter.',
    taxYear: 'Steuerjahr',
    source: 'Quelle',
    lastVerified: 'Zuletzt geprüft',
    lastVerifiedHint: 'Leer lassen für das heutige Datum.',
