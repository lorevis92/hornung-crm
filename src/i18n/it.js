export default {
  ...
  taxSettings: {
    ...
    scope: 'Ambito',
    value: 'Valore',
    valueAmount: 'Valore (CHF)',
    valuePercent: 'Valore (%)',
    valueType: 'Tipo di valore',
    valueType_fixed_amount: 'Importo fisso (CHF)',
    valueType_percentage: 'Percentuale',
    valueType_formula: 'Formula',
    valueType_no_cap: 'Nessun tetto',
    noCap: 'Nessun tetto',
    noCapHint: 'Questo parametro non ha un tetto numerico.',
    notes: 'Note',
    notesHint: 'Facoltativo — spiega la regola in linguaggio semplice, ad es. per un parametro basato su una formula.',
    taxYear: 'Anno fiscale',
    source: 'Fonte',
    lastVerified: 'Ultima verifica',
    lastVerifiedHint: 'Lascia vuoto per usare la data odierna.',
